...
//        	System.out.println("err: " + e.getMessage().toString());
    ...
    public static String submitPostJsonData(String strUrlPath,String params, Integer readTimeout) {
// 	   StrictMode.setThreadPolicy(new StrictMode.ThreadPolicy.Builder()
//        .detectDiskReads()
//        .detectDiskWrites()
//        .detectNetwork()
...
//        .build());
        ...
        try {
            ...
            //设置请求体的类型是文本类型
            httpURLConnection.setRequestProperty("Content-Type", "application/json; charset=UTF-8");//application/x-www-form-urlencoded
            //设置请求体的长度
            httpURLConnection.setRequestProperty("Content-Length", String.valueOf(data.length));
...
//             return dealResponseResult(inptStream);
    ...
    public static String submitPostJsonData(String strUrlPath,String params, String encode) {
        return submitPostJsonData(strUrlPath,params,5000);
    }
