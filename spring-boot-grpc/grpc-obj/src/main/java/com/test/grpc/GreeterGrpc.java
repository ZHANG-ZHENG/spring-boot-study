...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.test.grpc.HelloProto.HelloRequest,
      com.test.grpc.HelloProto.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.test.grpc.HelloProto.HelloRequest.class,
      responseType = com.test.grpc.HelloProto.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.test.grpc.HelloProto.HelloRequest,
      com.test.grpc.HelloProto.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.test.grpc.HelloProto.HelloRequest, com.test.grpc.HelloProto.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.test.grpc.HelloProto.HelloRequest, com.test.grpc.HelloProto.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.test.grpc.HelloProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.test.grpc.HelloProto.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.test.grpc.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.test.grpc.HelloProto.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(com.test.grpc.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.test.grpc.HelloProto.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingV2Stub
    ...
    /**
     */
    public com.test.grpc.HelloProto.HelloReply sayHello(com.test.grpc.HelloProto.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.test.grpc.HelloProto.HelloReply> sayHello(
        com.test.grpc.HelloProto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.test.grpc.HelloProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.test.grpc.HelloProto.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.test.grpc.HelloProto.HelloRequest,
              com.test.grpc.HelloProto.HelloReply>(
